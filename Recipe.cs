    ...
    public class Recipe
    {
        ...
        public static void FindRecipes()
        {
            ...
            for (num3 = 0; num3 < maxRecipes; num3++)
            {
                ...
                bool flag = true;
                int index = 0;
                while (index < maxRequirements)
                {
                    if (Main.recipe[num3].requiredItem[index].type == 0)
                    {
                        break;
                    }
                    int stack = Main.recipe[num3].requiredItem[index].stack;
                    for (int i = 0; i < 0x2c; i++)
                    {
                        if (Main.player[Main.myPlayer].inventory[i].IsTheSameAs(Main.recipe[num3].requiredItem[index]))
                        {
                            stack -= Main.player[Main.myPlayer].inventory[i].stack;
                        }
                        if (stack <= 0)
                        {
                            break;
                ...
                {
                    bool flag2 = true;
                    for (index = 0; index < maxRequirements; index++)
                    {
                        if (Main.recipe[num3].requiredTile[index] == -1)
                        {
                            break;
                        }
                        if (!Main.player[Main.myPlayer].adjTile[Main.recipe[num3].requiredTile[index]])
                        {
                            flag2 = false;
                            break;
                        }
        ...
        public static void SetupRecipes()
        {
            ...
            newRecipe.requiredTile[0] = 13;
            addRecipe();
            newRecipe.createItem.SetDefaults(0xff);
            newRecipe.requiredItem[0].SetDefaults(0x1f);
            newRecipe.requiredItem[1].SetDefaults(0xc3);
            ...
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0xf7);
            newRecipe.requiredItem[0].SetDefaults("Silk");
            newRecipe.requiredItem[0].stack = 20;
            newRecipe.requiredItem[1].SetDefaults(0xff);
            newRecipe.requiredItem[1].stack = 3;
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0xf8);
            newRecipe.requiredItem[0].SetDefaults("Silk");
            newRecipe.requiredItem[0].stack = 20;
            newRecipe.requiredItem[1].SetDefaults(0xff);
            newRecipe.requiredItem[1].stack = 3;
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0xf9);
            newRecipe.requiredItem[0].SetDefaults("Silk");
            newRecipe.requiredItem[0].stack = 20;
            newRecipe.requiredItem[1].SetDefaults(0xff);
            newRecipe.requiredItem[1].stack = 3;
            ...
            newRecipe.requiredItem[0].SetDefaults("Silk");
            newRecipe.requiredItem[0].stack = 20;
            newRecipe.requiredItem[1].SetDefaults(0xfe);
            newRecipe.requiredItem[1].stack = 3;
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0xf1);
            newRecipe.requiredItem[0].SetDefaults("Silk");
            newRecipe.requiredItem[0].stack = 20;
            newRecipe.requiredItem[1].SetDefaults(0xfe);
            newRecipe.requiredItem[1].stack = 3;
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x106);
            newRecipe.requiredItem[0].SetDefaults("Silk");
            ...
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0x103);
            newRecipe.requiredItem[0].SetDefaults(0x44);
            newRecipe.requiredItem[0].stack = 5;
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0xfc);
            newRecipe.requiredItem[0].SetDefaults(0x103);
            newRecipe.requiredItem[0].stack = 15;
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(0xfd);
            newRecipe.requiredItem[0].SetDefaults(0x103);
            newRecipe.requiredItem[0].stack = 15;
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
            newRecipe.createItem.SetDefaults(250);
            newRecipe.requiredItem[0].SetDefaults(0x105);
            newRecipe.requiredItem[0].stack = 2;
            newRecipe.requiredItem[1].SetDefaults(0x1f);
            newRecipe.requiredTile[0] = 0x12;
            addRecipe();
